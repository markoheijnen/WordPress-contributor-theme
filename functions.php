...
if ( ! function_exists( 'contributor_setup' ) ) :
/**
...
endif; // contributor_setup
add_action( 'after_setup_theme', 'contributor_setup' );
 ...
 */
function contributor_widgets_init() {
...
add_action( 'widgets_init', 'contributor_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function contributor_scripts() {
...
add_action( 'wp_enqueue_scripts', 'contributor_scripts' );
